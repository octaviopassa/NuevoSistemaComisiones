  ...
  const handleFolioChange = async (newFolio) => {
    ...
    try {
      ...
      const newDocumentos = detalle.map((doc) => {
        ...
        return {
          ...
          xmlArchivo: doc?.IDXML
            ...
            : "",
          fecha1ComisionDetalle: doc.FECHA1_COMISION ? format(new Date(doc.FECHA1_COMISION), "yyyy-MM-dd") : "",
          fecha2ComisionDetalle: doc.FECHA2_COMISION ? format(new Date(doc.FECHA2_COMISION), "yyyy-MM-dd") : "",
        };
      });
      ...
      setMultiple({
        ...
        selectedRepresentante: gastos.ORIGEN === "I" ? gastos.CODIGO_REPRESENTANTE : "",
